...
pub type ODPISubscrCallback = Option<
    unsafe extern "C" fn(
...
extern "C" {
    ...
    pub fn dpiConn_setStmtCacheSize(
        conn: *mut opaque::ODPIConn,
        cacheSize: u32,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    ...
    pub fn dpiMsgProps_setExpiration(
        props: *mut opaque::ODPIMsgProps,
        value: i32,
    ) -> ::std::os::raw::c_int;
    ...
    pub fn dpiMsgProps_setPriority(
        props: *mut opaque::ODPIMsgProps,
        value: i32,
    ) -> ::std::os::raw::c_int;
}
...
extern "C" {
    ...
    pub fn dpiObject_deleteElementByIndex(
        obj: *mut opaque::ODPIObject,
        index: i32,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    ...
    pub fn dpiPool_getTimeout(
        pool: *mut opaque::ODPIPool,
        value: *mut u32,
    ) -> ::std::os::raw::c_int;
    pub fn dpiPool_release(pool: *mut opaque::ODPIPool) -> ::std::os::raw::c_int;
    pub fn dpiPool_setGetMode(
        pool: *mut opaque::ODPIPool,
        value: enums::ODPIPoolGetMode,
    ) -> ::std::os::raw::c_int;
    pub fn dpiPool_setMaxLifetimeSession(
        pool: *mut opaque::ODPIPool,
        value: u32,
    ) -> ::std::os::raw::c_int;
    pub fn dpiPool_setStmtCacheSize(
        pool: *mut opaque::ODPIPool,
        cacheSize: u32,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    ...
    pub fn dpiStmt_getBatchErrorCount(
        stmt: *mut opaque::ODPIStmt,
        count: *mut u32,
    ) -> ::std::os::raw::c_int;
